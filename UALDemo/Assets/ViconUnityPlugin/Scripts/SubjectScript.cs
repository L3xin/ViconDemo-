    ...
    public class SubjectScript : MonoBehaviour
    {
        ...
        private void ApplyBoneTransform(Transform Bone)
        {
            ...
            if (OTran.Result == Result.Success)
            {
                ...
                Debug.Log("The location : X = " + ((float)OTran.Translation[0] * 0.001f) + "Y = " + ((float)OTran.Translation[1] * 0.001f) + "Z = " + ((float)OTran.Translation[2] * 0.001f));
